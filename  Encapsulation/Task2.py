...
class Hero():
    ...
    def strike_hero(self, rascal):
        print(
            'Удар! ' + self.name + ' атакует ' + rascal.name + ' с силой ' + str(self.power) + ', используя ' + self.weapon +'\n'
        )
        ...
        sleep(2)
        print (
            "Класс брони " + rascal.name + ' упал до ' + str(rascal.armor) + ', а количество здоровья уменьшилось до ' + str(rascal.health) + '\n'
        )

    def strike_enemy(self, knight):
        print(
            'Удар! ' + self.name + ' атакует ' + knight.name + ' с силой ' + str(self.power) + ', используя ' + self.weapon +'\n'
        )
        ...
        sleep(2)
        print (
            "Класс брони", knight.name, 'упал до ' + str(knight.armor) + ', а количество здоровья уменшьшилось до ' + str(knight.health) + '\n'
        )
